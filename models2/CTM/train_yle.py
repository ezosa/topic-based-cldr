...
argparser.add_argument('--train_data', default='/proj/zosa/data/yle/yle_articles_2017_fi.txt', type=str, help="text file with one document per line")
...
argparser.add_argument('--lang', default='fi', type=str, help="lang code of training data")
#argparser.add_argument('--num_docs', default=20000, type=int, help="no. of docs to use for training")
args = argparser.parse_args()


print("----- Training ContextualizedTM on Yle data -----")
